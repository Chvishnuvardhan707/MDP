    ...
    <div class="container" >
      ...
      <div class="row">
        ...
        <div class="form-group">
          <input class="form-control" type="text" name="uname" value="" placeholder="Enter Username">
        </div>
        <div class="form-group">
          <input class="form-control" type="password" name="pwd" value="" placeholder="Enter password"/>
        </div>
        <div class="form-group">
