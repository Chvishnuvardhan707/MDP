        ...
        <div class="container-fluid">
            ...
            if(isset($_GET['teacher_Id'])){
             $id = $_GET['teacher_Id'];
                ...
                $sql = $pdo->prepare("SELECT * FROM `tbl_teacher` WHERE `teacher_Id`='$id'");
                $sql->execute();
                $result = $sql->fetchall();
                ...
                if(isset($edit))
                {
                    ...
                    $sql = $pdo->prepare("UPDATE `tbl_teacher` SET `fname`='$fname',`mname`='$mname',`lname`='$lname',`uname`='$username',`pwd`=md5('$password') WHERE `teacher_Id`='$id'");
                    $sql->execute();
