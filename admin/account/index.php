                   ...
                   <div class="row-fluid">
                     <div class="span6">
                        ...
                        <div class="block">
                            ...
                            $sql = $pdo->prepare("SELECT * FROM `tbl_admin`");
                            $sql->execute();
                            $result =$sql->fetchall();
                            foreach($result as $row) {?>
                                                                <form method="POST">
                                 <label>Username</label>
                                    <input type="text" class="form-control" name="user"value=<?php echo $row['adm_user'];?>>
                                <label>Password</label>
                                    <input type="password" class="form-control" name="pwd" value=<?php echo $row['adm_pwd'];?>><br>
                           ...
                           <?php }
                            ...
                            <?php
                                ...
                                extract($_POST);
                                    if(isset($upt))
                                    {
                                        $s = $pdo->prepare("UPDATE tbl_admin SET adm_user ='$user',adm_pwd='$pwd' WHERE adm_Id");$s->execute();;
